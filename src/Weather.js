...
function Weather() {
    ...
    const [place, setPlace] = useState(localStorage.getItem('place') === null? defaultPlace : JSON.parse(localStorage.getItem('place')));
    ...
    function handlePlaceChange(place) {
        ...
        setPlace(placeInfo);
        localStorage.setItem('place', JSON.stringify(placeInfo));
    }
